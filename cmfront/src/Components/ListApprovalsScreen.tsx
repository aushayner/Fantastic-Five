//import ListScreenElement from "./ListScreenElement"
...
function ListApprovalsScreen(){    
    ...
    const getChangeRequests = async() =>{
        ...
        const response = await fetch("http://localhost:8080/approvals"
            ...
            <div className={"ListGroup overflow-auto"}>
                ...
                <Table striped bordered hover>
                    ...
                    {changeRequests.map((changerequest) => (
                        <tr onClick={()=>{navigate('/view-approval/'+changerequest.requestId)}}>
...
export default ListApprovalsScreen